...
public class JWTLoginFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public JWTLoginFilter(String url, AuthenticationManager authenticationManager, TokenAuthenticationService tokenAuthenticationService) {
        ...
        Assert.notNull(tokenAuthenticationService, "TokenAuthenticationService cannot be empty.");
    ...
    public Authentication attemptAuthentication(
        ...
        try {
            creds.setPassword(BVAUtils.getInstance().encode(creds.getPassword()) /*creds.getPassword()*/);
